...
UNITTEST_STAGE=unittest
UNITTEST_DYNAMODB_PORT=8200
UNITTEST_DYNAMODB_TABLE_NAME=tmp_table
UNITTEST_DYNAMODB_REGION=`jq -r  .AWS_REGION ${LOCAL_CONF_PATH}/conf.json`
UNITTEST_DYNAMODB_ENDPOINT_URL="http://localhost:${UNITTEST_DYNAMODB_PORT}"
